/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9d6c03d25efc2998bcd01c4d81c95a86)
// Runtime types generated with workerd@1.20260831.1 2026-09-01 global_fetch_strictly_public
interface __BaseEnv_Env {
	...
	DELIVERY_WORKFLOW: Workflow<Parameters<import("./src/worker").DeliveryWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "PAYMENT_MODE" | "X402_FACILITATOR_URL" | "X402_NETWORK" | "X402_ASSET" | "X402_AMOUNT_ATOMIC" | "X402_PAY_TO" | "X402_ASSET_NAME" | "X402_ASSET_VERSION">> {}
}
